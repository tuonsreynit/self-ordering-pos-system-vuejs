            ...
            <div class="p-5">
                ...
                <div>
                    <div class=" m-2 text-gray-500">
                        ...
                        <p class="">ចំនូនប្រាក់: <span class=" text-lg text-black">{{ ConvertToKhmerNumber(order.totalPrice) }}៛</span></p>
                    </div>
                    <div class="flex items-center justify-end pt-2.5 border-t border-t-[#ccc]">
                        ...
                        <button @click="refund(order._id, order.totalPrice)" class=" ml-4 rounded bg-[#fc1a1a] hover:bg-[#d12439] text-white px-3 py-1.5" type="submit">សងប្រាក់</button>
                    </div>
                </div>
            </div>
        </div>
